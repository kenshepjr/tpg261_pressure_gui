...
class Data_Structure_TPG261:
    ...
    def data_update(self, t0):
        """ Append Data to Lists"""
        
        self.abs_time_list.append(datetime.datetime.now())
        self.time_list.append((time.time() - t0)/60)
...
def initialize_controllers():
    ...
    TPG261_data = Data_Structure_TPG261('Pfieffer TPG261 Single Gauge')
    
    # TPG261 Pressure Controller
    TPG261 = mod_Pfieffer_TPG261.pfieffer_single_gauge_TPG261(ports['TPG261'])
...
if __name__=='__main__':    
    ...
    ports = {}
    ports['TPG261'] = 'COM23'
    TPG261_data, TPG261 = initialize_controllers()
    
    t0 = time.time()
    dt = 1000//5  # update time in milliseconds
